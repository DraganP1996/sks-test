...
export const loadMarketCategoriesSuccess = createAction(LOAD_MARKET_CATEGORIES_SUCCESS, props<{ marketCategories: MarketCategory[]}>());
export const loadMarketCategoriesFailure = createAction(LOAD_MARKET_CATEGORIES_FAILURE, props<{ error: Error }>());

export const setMarketCategories = createAction(SET_MARKET_CATEGORIES, props<{ marketCategories: MarketCategory[] }>());
export const upsertMarketCategories = createAction(UPSERT_MARKET_CATEGORIES, props<{ marketCategories: MarketCategory[] }>());
